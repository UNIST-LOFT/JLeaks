public String createMetadata(Object nativeItem){
    ...
    metadata.append("<didl:Descriptor>").append("<didl:Statement mimeType=\"application/xml; charset=utf-8\">").append("<dii:Identifier xmlns:dii=\"urn:mpeg:mpeg21:2002:01-DII-NS\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xsi:schemaLocation=\"urn:mpeg:mpeg21:2002:01-DII-NS http://standards.iso.org/ittf/PubliclyAvailableStandards/MPEG-21_schema_files/dii/dii.xsd\">").append("urn:" + itemURI).append("</dii:Identifier>").append("</didl:Statement>").append("</didl:Descriptor>");
    ...
    for (int i = 0; i < allDC.length; i++) {
        ...
        boolean provenance = allDC[i].qualifier != null && allDC[i].qualifier.equals("provenance");
        if (!(description && provenance)) {
            ...
            metadata1.append("<dc:").append(allDC[i].element).append(">").append(value).append("</dc:").append(allDC[i].element).append(">");
        }
    }
    ...
    metadata.append("</oai_dc:dc>").append("</didl:Statement>").append("</didl:Descriptor>");
    /**
     * putfirst item here*
     */
    // **CYCLE HERE!!!!**//
