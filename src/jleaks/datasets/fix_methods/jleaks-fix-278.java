public static void launch(String classPath, String mainClassLoaderName, String classLoaderName,
    ...
    Constructor<?> mainClassLoaderCons = contextClassLoader.loadClass(mainClassLoaderName).getConstructor(URL[].class, ClassLoader.class);
    ClassLoader mainClassLoader = (ClassLoader) mainClassLoaderCons.newInstance(urls.toArray(new URL[urls.size()]), contextClassLoader.getParent());
