    ...
    switch(p) {
        ...
        case WINDOWS:
            ...
            if (isJava15() || isJava14()) {
                ...
                args.add(jdkBundle + " /s /v\"/qn REBOOT=ReallySuppress INSTALLDIR=\\\"" + expectedLocation + "\\\" /L \\\"" + expectedLocation + "\\jdk.exe.install.log\\\"\"");
            } else {
                ...
                args.add("REBOOT=ReallySuppress", "INSTALLDIR=" + expectedLocation, "/L \\\"" + expectedLocation + "\\jdk.exe.install.log\\\"");
            }
