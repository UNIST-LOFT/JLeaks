public static void main(final String[] args)throws Exception{
    ...
    MESSAGE_HEADER.reset(directBuffer, bufferOffset, messageTemplateVersion).blockLength(CAR.blockLength()).templateId((int) CAR.templateId()).version((short) CAR.templateVersion());
