public void dumpState(long blockNumber, int txNumber, String txHash) 
{
    ...
    if (txHash != null)
        fileName = String.format("%d_%d_%s.dmp", blockNumber, txNumber, txHash.substring(0, 8));
    ...
    try {
        ...
        for (ByteArrayWrapper key : keys) {
            ...
            String accountLine = JSONHelper.dumpLine(key.getData(), nonce.toByteArray(), balance.toByteArray(), stateRoot, codeHash, code, storage);
